...
base='http://rimlys.web44.net'
ADDON=xbmcaddon.Addon(id='plugin.video.rimlysbuild')
...
def CATEGORIES():
    link = OPEN_URL('http://rimlys.web44.net/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]rimlysbuild Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
